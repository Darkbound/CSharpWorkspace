namespace DefineClasses2nd.Heroes
{
    ...
    public class HeroInitializer : HeroFactory
    {
        ...
        private const int DEFAULT_TANK_HEALTH = 1000;
        private const int DEFAULT_TANK_MANA = 100;
        private const int DEFAULT_TANK_STRENGTH = 20;
        ...
        private const int DEFAULT_FIGHTER_HEALTH = 900;
        private const int DEFAULT_FIGHTER_MANA = 100;
        private const int DEFAULT_FIGHTER_STRENGTH = 10;
        private const int DEFAULT_FIGHTER_AGILITY = 20;
        ...
        private const int DEFAULT_SORCERER_HEALTH = 800;
        ...
        private const int DEFAULT_SORCERER_INTELLIGENCE = 20;
